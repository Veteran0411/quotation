...
const GenSpec = () => {
  return (
    <div>
      <h1 className="text-left italic text-2xl font-semibold underline px-1 py-1 box-border">
        ASHOK LEYLAND Make:
      </h1>
      <div className="border border-black p-4 max-w-5xl box-border">
        ...
        <div className="flex justify-between mt-1 text-right">
